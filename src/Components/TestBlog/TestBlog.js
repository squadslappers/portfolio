...
const Blog = (props) => {
  ...
  return (<div className='obligatory-div'>
    ...
    <div className='mini-header' id='blue-header'>
      <h1>A SIMPLE TRICK TO SIMPLIFY JAVASCRIPT</h1>
      <span>December 31, 2020</span>
    </div>
    <div className = 'blog-content'>
      <div className='tldr'>
        TL;DR: When you're overwhelmed by JavaScript, remember that there are only a few data types, and you can only do 4 things to them (i.e. Create, Read, Update, and Delete).
      </div>
      ...
      <p>
      <strong>There's always more to learn.</strong> It’s worth repeating. It’s a fact, and it’s up to us to either shy away from that fact or embrace it. I’ve decided to embrace it, and one of the most effective ways I’ve learned to embrace it is to remember a few of the other fundamental truths.
      </p>
      ...
      <p><strong>Remember there are only a few data types, and you can only do 4 things to them.</strong></p>
      <h1>Focus on the Fundamentals</h1>
      <p>
        When you’re feeling lost, confused, stuck, angry, frustrated, or any of the other emotions that come with the job, take a step back and focus on the fundamentals. <strong>Ask yourself, "What data types am I working with, and what am I trying to do with them?"</strong> The answer to that question will serve as a simplified version of what you’re trying to accomplish: </p>
      <ul>
